/***********************************************************************
 * Source File:
 *    KING: King's main functionality
 * Author:
 *    Shandler Rechenberger & Daryl Appleton
 * Summary:
 *    All of the King's functionality is calculated here.
 ************************************************************************/
#include "Piece.h"
#include "Move.h"
#include "Board.h"
...
/***********************************************
 * KING::GET MOVES
 * Calculates all the possible moves for King.
 ***********************************************/
std::set <Move> King::getMoves(const Board* board) const
{
